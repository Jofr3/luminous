...
export function useSimulatorActions(
  ...
  return {
    ...
    actions: {
      ...
      toggleDiscardSelectionCard: (uid) => dispatch({ type: "toggleDiscardSelectionCard", uid }, { history: "skip" }),
      confirmDiscardSelection: () => dispatch({ type: "confirmDiscardSelection" }, { history: "replace" }),
      cancelDiscardSelection: () => dispatch({ type: "cancelDiscardSelection" }, { history: "replace" }),
